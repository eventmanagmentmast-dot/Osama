...
const assets={};
for(const file of ['index.html','app.js','style.css','warehouse.js','business.js','qrcode.js','experience.js','experience.css','premium.css','finance-core.js','finance-ui.js','approval-ui.js','reconciliation-ui.js','partners-ui.js','equipment-ui.js','catalogue-ui.js','lcv-ui.js','pdf-reader.mjs','pdf-engine.mjs','pdf-worker.mjs','sample.json'])assets['/'+(file==='index.html'?'':file)]=await read(file);
